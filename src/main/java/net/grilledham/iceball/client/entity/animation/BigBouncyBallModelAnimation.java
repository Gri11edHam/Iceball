...
public class BigBouncyBallModelAnimation {
	...
	public static final Animation BIG_BOUNCE = Animation.Builder.create(1.0F)
			.addBoneAnimation("root", new Transformation(Transformation.Targets.SCALE,
					...
					new Keyframe(0.625F, AnimationHelper.createScalingVector(0.6F, 1.4F, 0.6F), Transformation.Interpolations.LINEAR),
					new Keyframe(0.75F, AnimationHelper.createScalingVector(1.1F, 0.8F, 1.1F), Transformation.Interpolations.LINEAR),
					new Keyframe(0.875F, AnimationHelper.createScalingVector(0.9F, 1.1F, 0.9F), Transformation.Interpolations.LINEAR),
