...
public class BigBouncyBallModel extends HierarchicalModel<BigBouncyBallEntity> {
	...
	@Override
	public void setupAnim(BigBouncyBallEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		root.getAllParts().forEach(ModelPart::resetPose);
		animate(entity.smallBounceAnimationState, BigBouncyBallModelAnimation.SMALL_BOUNCE, ageInTicks);
		animate(entity.bigBounceAnimationState, BigBouncyBallModelAnimation.BIG_BOUNCE, ageInTicks);
	}
